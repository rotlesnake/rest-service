    ...
    public static function modelInfo() {
      ...
      return [
           ...
           "columns"=>[
                   ...
                   "login"=>["type"=>"string", "label"=>"Логин", "rules"=>"[v=>v.length > 3 || 'Обязательное поле']", "read"=>$acc_all, "add"=>$acc_admin, "edit"=>$acc_admin, "visible"=>true], 
                   ...
                   "blocking_comment"=>["type"=>"string", "label"=>"Причина блокировки", "rules"=>"[v=>v.length > 3 || 'Обязательное поле']", "vif"=>"[status] < 0", "read"=>$acc_all, "add"=>$acc_admin, "edit"=>$acc_admin, "visible"=>true], 
                   "photo"=>["type"=>"images", "label"=>"Фотография", "multiple"=>false, "read"=>$acc_all, "add"=>$acc_all, "edit"=>$acc_all, "name"=>"photo", ], 

                   "token"=>["type"=>"string", "label"=>"Токен", "index"=>"index", "width"=>200,         "read"=>[], "add"=>[], "edit"=>[], "name"=>"token", "hidden"=>true, "masked"=>false, ], 
